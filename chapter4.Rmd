...
<<<<<<< HEAD
First I'll scale the Boston data, that is standardize the variables and save it as a data.frame instead of a matrix. When variables are standardized their mean is adjusted to zero as can be seen from the summaries of the scaled variables which are shown below. Also 
=======
...
>>>>>>> 161e7d485b469331b35627e03198245ebd78f0f3
